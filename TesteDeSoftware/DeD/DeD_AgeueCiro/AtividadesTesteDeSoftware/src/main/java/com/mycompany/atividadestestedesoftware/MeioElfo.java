...
public class MeioElfo implements DistribuirPontosStrategy {

    private Map<String, Integer> conjuntoAtributos;

    public MeioElfo(DistribuirEscolha27 classeDistribuirEscolha27) {
    ...
    public void setAtributo() {
        conjuntoAtributos.put("Carisma", conjuntoAtributos.get("Carisma") + 2);
    }
