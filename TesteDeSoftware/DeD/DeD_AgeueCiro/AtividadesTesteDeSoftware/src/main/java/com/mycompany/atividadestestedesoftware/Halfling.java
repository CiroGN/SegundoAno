...
public class Halfling implements DistribuirPontosStrategy {

    private Map<String, Integer> conjuntoAtributos;

    public Halfling(DistribuirEscolha27 classeDistribuirEscolha27) {
    ...
    public void setAtributo() {
        conjuntoAtributos.put("Destreza", conjuntoAtributos.get("Destreza") + 2);
    }
