...
public class Gnomo implements DistribuirPontosStrategy {

    private Map<String, Integer> conjuntoAtributos;

    public Gnomo(DistribuirEscolha27 classeDistribuirEscolha27) {
    ...
    public void setAtributo() {
        conjuntoAtributos.put("Inteligencia", conjuntoAtributos.get("Inteligencia") + 2);
    }
